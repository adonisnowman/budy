...
CKEDITOR.dialog.add( 'videoDialog', function( editor ) {
    return {
        ...
        onOk: function() {
            ...
            else if(respuesta.reproductor == "facebook"){
                var url = "https://www.facebook.com/chaohsuanchang/videos/"+respuesta.id_video;
            }
            ...
            var iframe;
            if(respuesta.reproductor == "facebook"){
            	iframe = new CKEDITOR.dom.element( 'div' );
                iframe.setAttribute("data-href", url);
