...
class VideoController extends BaseController
{
	...
	public function insertAction($viewType='')
	{
		if ($this->request->isPost()) {
			...
			var_dump($info);
			if( Video::count(" video_id = '{$info['video_id']}' ") > 0){
				exit;
			}
	...
	public function viewsAction($viewType='')
	{
		...
		$ProductCategory = ProductCategory::find(array('parent_category = 1 AND onshelf = 1 ',"order" => "sort ASC"));
