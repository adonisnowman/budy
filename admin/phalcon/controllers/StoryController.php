...
class StoryController extends BaseController
{
	...
	public function insertAction($viewType='')
	{
		if ($this->request->isPost()) {
			...
			var_dump($info);
			if( Story::count(" video_id = '{$info['video_id']}' ") > 0){
				exit;
			}
	...
	public function viewsAction($viewType='')
	{
		...
		$ProductCategory = ProductCategory::find(array('parent_category = 32 AND onshelf = 1 ',"order" => "sort ASC"));
